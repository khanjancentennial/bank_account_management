...
* The original package name 'com.bankaccountmanagement.bank-account-management' is invalid and this project uses 'com.bankaccountmanagement.bank_account_management' instead.
